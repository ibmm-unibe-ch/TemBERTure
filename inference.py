...
def regression_test_data(raw_test_ds):
    ...
    #raw_test_ds = Dataset.from_pandas(raw_test_ds) 
...
def test_out(task,model,tokenizer,raw_test_df,best_model_path,BATCH_SIZE):
    ...
    if task == 'regression' or task == 'regression_on_classification_data':
        ...
        df.columns =['id','sequence','cls_label','tm','id2','species','prediction','prediction_score']
