...
if __name__ == "__main__":
    ...
    elif args.do_test and 'T5' in args.model_type.upper():
        from t5_evaluate import T5_evaluate_out
        T5_evaluate_out(cls_test = args.cls_test_data, 
                        regr_test = args.regr_test_data, 
                        model_name_or_path = args.model_name_or_path, 
                        best_adapter_path = args.best_model_path,
                        adapters = args.with_adapters)
